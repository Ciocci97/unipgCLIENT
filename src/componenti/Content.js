	...
	render() {
		if (this.props.stato === 'login') {
            ...
            <div style={{ background: '#fff', padding: 24, minHeight: 5 }}>    
                <form class="info">
                        <div style={{ background: '#fff', padding: 24, minHeight: 5 }}>
							<h1><b>Informazioni Segreteria:</b> Dipartimento di matematica e informatica</h1>
						</div>        
                
                        <div style={{ background: '#fff', padding: 24, minHeight: 5 }}>
							<h4><b>-Indirizzo:</b> Via L. Vanvitelli, 1 06123 Perugia </h4>
						</div>
                
                        <div style={{ background: '#fff', padding: 24, minHeight: 5 }}>
							<h4><b>-Ufficio:</b> IV Piano </h4>
						</div>
                
                        <div style={{ background: '#fff', padding: 24, minHeight: 5 }}>
							<h4><b>-Tel:</b> 075 585 5071</h4>
						</div>
                            
                        <div style={{ background: '#fff', padding: 24, minHeight: 5 }}>
							<h4><b>-Fax:</b> 075 585 5024</h4>
						</div>
                
                        <div style={{ background: '#fff', padding: 24, minHeight: 5 }}>
							<h4><b>-Email:</b> <a href="segr-didattica.mat.dmi@unipg.it"> segr-didattica.mat.dmi@unipg.it </a></h4>
						</div>
                </form>
            </div>
					</Content>
			...
			return (
                ...
                <form class="info">
                        <div style={{ background: '#fff', padding: 24, minHeight: 5 }}>
							<h1><b>Informazioni Biblioteca:</b> Dipartimento di matematica e informatica</h1>
						</div>        
                        ...
                        <div style={{ background: '#fff', padding: 24, minHeight: 5 }}>
							<h4><b>-Tel:</b> 075.585.5026/5027</h4>
						</div>
                            
                        <div style={{ background: '#fff', padding: 24, minHeight: 5 }}>
							<h4><b>-Fax:</b> 075.585.5965</h4>
						</div>
                     </form>
            </div>
					</Content>
